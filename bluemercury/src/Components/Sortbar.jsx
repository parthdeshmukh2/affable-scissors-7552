  ...
  return (
    ...
    <Box p='4' >
     <Flex direction={"column"} pt={"30px"} border={"1px solid red"} >
        <Box fontFamily={"Montserrat Medium,sans-serif"}>Home &gt; New Arrivals</Box>
       
        <Box fontFamily={"Montserrat Medium,sans-serif"} pt={"30px"}>NEW ARRIVALS CATEGORY  </Box>
     </Flex>
    </Box>
    <Spacer />
    <Box p='4'fontSize={"30px"} textAlign={"center"} mt={"40px"} fontFamily={"Montserrat Medium,sans-serif"}>
    NEW ARRIVALS
    </Box>
    <Spacer />
   ...
   <Box p='4'fontFamily={"Montserrat Medium,sans-serif"} >
     ...
     <Select placeholder='Featured' cursor={"pointer"} p={"10px"} fontFamily={"Montserrat Medium,sans-serif"}>
