...
<Box w="40%" mr="35px" bg="#F8F8F8" h="250px"  border={"1px solid black"} display="flex"
...
<Box w="40%" bg="#F8F8F8" h="130px" mr="35px" border={"1px solid black"} display="flex"
flexDirection="column" gap="8px" p="10px 25px">
